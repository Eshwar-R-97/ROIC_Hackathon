...
export default function IdeasPage() {
  ...
  function handleSelect(id: string) {
    update({ selectedIdeaId: id, step: 5 });
      ...
      <main className="min-h-screen py-12 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="text-center py-20">
            ...
            <p className="text-gray-500 text-sm">Generating 10 personalized ideas...</p>
            <p className="text-gray-400 text-xs mt-2">This may take 20-30 seconds</p>
          </div>
        </div>
      </main>
    );
